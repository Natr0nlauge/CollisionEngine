...
void CollisionResolver::handleCollision(collisionEvent_type & c_collEvent) {
    ...
    // TODO make this more readable, use subfunctions
    ...
    sf::Vector2f velocityPerUnitImpulse1 = sfu::pseudoCrossProduct2(rotationPerUnitImpulse1, relativePosition1);
    sf::Vector2f velocityPerUnitImpulse2 = sfu::pseudoCrossProduct2(rotationPerUnitImpulse2, relativePosition2);
    ...
    sf::Vector2f closingVel1 = sfu::pseudoCrossProduct2(angVel1, relativePosition1);
    sf::Vector2f closingVel2 = sfu::pseudoCrossProduct2(angVel2, relativePosition2);
    ...
    if (contactVel > 0) {         // Avoid objects getting stuck inside each other
        float restitution = 1.0f; // depends on material //TODO initialize this somewhere else and use caps
