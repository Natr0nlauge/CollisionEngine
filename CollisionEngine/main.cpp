...
int main() {
  ...
  std::vector<sf::Vector2f> exampleVertices = {
      sf::Vector2f(25.0f, -25.0f), sf::Vector2f(-25.0f, -50.0f),
  ...
  std::vector<sf::Vector2f> exampleVertices2 = {
      sf::Vector2f(2.0f, -25.0f), sf::Vector2f(-2.0f, -25.0f),
      sf::Vector2f(-2.0f, 25.0f), sf::Vector2f(2.0f, 25.0f)};
